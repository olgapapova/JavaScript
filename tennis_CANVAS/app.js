"use strict";
       ...
       let cenBr=heightPole/2-heightBric/2; // расположение ракетки по центру поля
       ...
       let cvs=document.getElementById('tennis');
       ...
       let pole={
          ...
          size : function() {
             let pol=cvs.getContext('2d');
             pol.fillStyle='#FFD700';
             pol.strokeStyle='black';
             pol.fillRect(0, 0, widthPole, heightPole);
             pol.strokeRect(0, 0, widthPole, heightPole);
         }
       };
       pole.size();
       ...
       let leftBric={
          ...
          update : function() {
            let leftBric=cvs.getContext('2d');
            leftBric.fillStyle='green';
            leftBric.beginPath();
            leftBric.fillRect(this.posX, this.posY, this.width, this.height);
          }
       };
       leftBric.update();
       ...
       let rightBric={
          ...
          update : function() {
            let rightBric=cvs.getContext('2d');
            rightBric.fillStyle='blue';
            rightBric.beginPath();
            rightBric.fillRect(this.posX, this.posY, this.width, this.height);
          }
       };
       rightBric.update();
       ...
       let ball={
          ...
          update : function() {
            let ball=cvs.getContext('2d');
            ball.fillStyle='red';
            ball.beginPath();
            ball.arc(this.posX, this.posY, this.radius, 0, Math.PI*2, false);
            ball.fill();
          }
       };
       ball.update();
